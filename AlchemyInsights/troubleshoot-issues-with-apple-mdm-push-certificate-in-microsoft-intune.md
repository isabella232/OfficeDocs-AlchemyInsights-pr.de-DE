...
ms.locfileid: "29470232"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Behandeln von Problemen mit Apple MDM Push-Zertifikat in Microsoft Intune

Überprüfen Sie die unten aufgeführten Ressourcen zur Lösung des Problems jetzt. 
  
1. Lesen Sie [Dieses Dokument](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) zum Konfigurieren oder MDM Apple-Push-Zertifikat zu erneuern. 
