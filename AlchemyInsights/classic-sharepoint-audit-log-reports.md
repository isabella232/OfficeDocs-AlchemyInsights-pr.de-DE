...
- Der **Inhaltsanzeige** -Überwachungsprotokollbericht wird in SharePoint Online nicht unterstützt. Wenn Sie versuchen, den Bericht zu speichern, erhalten Sie den Fehler: der **Bericht enthält keine Daten**.

- Sie müssen die Suchfunktion des Überwachungsprotokolls im Security & Compliance Center verwenden, um die SharePoint-und OneDrive-Überwachungsprotokolle abzurufen. Weitere Informationen finden Sie unter [Durchsuchen des Überwachungsprotokolls](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#search-the-audit-log).
