...
ms.locfileid: "54102903"
---
# <a name="create-mailboxes-that-dont-require-licenses"></a>Erstellen von Postfächern, für die keine Lizenzen erforderlich sind

- Wenn Sie eine Gruppen-E-Mail-Adresse für mehrere Personen benötigen, lesen [Sie "Erstellen eines freigegebenen](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox)Postfachs".
