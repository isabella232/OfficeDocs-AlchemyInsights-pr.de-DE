...
Die Reihenfolge von Unterbezeichnung erfolgt durch [automatische Kennzeichnung](https://docs.microsoft.com/microsoft-365/compliance/apply-sensitivity-label-automatically). Wenn Sie Bezeichnungen so konfigurieren, dass Sie automatisch oder als Empfehlung angewendet werden, können daraus mehrere Übereinstimmungen für mehrere Bezeichnungen resultieren. Weitere Informationen finden Sie unter [Bezeichnungspriorität (Auftragsangelegenheiten)](https://docs.microsoft.com/microsoft-365/compliance/sensitivity-labels).