...
Verwenden Sie ihre lokale Active Directory-Benutzer- und Gruppenverwaltungskonsole (adsiedit.msc), um synchronisierte Benutzer und alle ihre Attribute vollständig zu verwalten.  
