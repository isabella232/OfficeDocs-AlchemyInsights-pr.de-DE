...
1. Wählen Sie unten im Navigationsbereich **Personen**aus.
    
2. Wählen Sie oben auf der Seite * * Manage * \> * **Export**aus.
...
4. Klicken Sie unten auf der Seite auf **Speichern** , und "Contacts. csv" wird im standardOrdner "Downloads" gespeichert. Um auszuwählen, wo die CSV-Datei gespeichert werden soll, wählen Sie den Pfeil neben speichern und dann **Speichern**unter aus. 
