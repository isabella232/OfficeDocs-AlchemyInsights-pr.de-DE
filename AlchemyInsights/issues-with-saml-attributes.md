...
2. [Überprüfen Sie die genehmigten Attributwerte, die](https://docs.microsoft.com/azure/active-directory/develop/active-directory-claims-mapping#table-3-valid-id-values-per-source) für Ansprüche nach gültigen ID-Werten pro Quelle abgerufen werden können.
