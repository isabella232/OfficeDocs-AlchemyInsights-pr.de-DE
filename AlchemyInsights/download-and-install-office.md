...
ms.locfileid: "28289949"
---
# <a name="download-and-install-office"></a><span data-ttu-id="45e9a-102">Office herunterladen und installieren</span><span class="sxs-lookup"><span data-stu-id="45e9a-102">Download and install Office</span></span>

<span data-ttu-id="45e9a-p101">Ihr Abonnement **Business Essentials** umfasst nicht die Office-apps. Um Office erhalten möchten, müssen Sie auf das **Business** oder **Business Premium** -Abonnement zu aktualisieren. Sehen Sie sich hier die verfügbaren Abonnements mit Office: [Office 365 Business-Pläne](https://products.office.com/en-us/compare-all-microsoft-office-products?tab=2)</span><span class="sxs-lookup"><span data-stu-id="45e9a-p101">Your **Business Essentials** subscription does not include the Office apps. In order to get Office, you will need to upgrade to the **Business** or **Business Premium** subscription. Check out the available subscriptions with Office here: [Office 365 Business Plans](https://products.office.com/en-us/compare-all-microsoft-office-products?tab=2)</span></span>
