...
ms.locfileid: "29934235"
---
# <a name="issues-with-microsoft-bookings"></a><span data-ttu-id="6ede7-102">Probleme mit Microsoft Buchungen</span><span class="sxs-lookup"><span data-stu-id="6ede7-102">Issues with Microsoft Bookings</span></span>

<span data-ttu-id="6ede7-103">Klicken Sie bei Problemen mit dem neuen Feature von Microsoft Bookings finden Sie unter [Buchungen Artikel](https://support.office.com/article/b9c9295c-c654-4b10-b5cc-f739825fc092.aspx).</span><span class="sxs-lookup"><span data-stu-id="6ede7-103">To troubleshoot issues with the new Microsoft Bookings feature, see [Bookings articles](https://support.office.com/article/b9c9295c-c654-4b10-b5cc-f739825fc092.aspx).</span></span>
