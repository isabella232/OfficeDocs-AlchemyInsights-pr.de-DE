...
---
# <a name="delete-sites-that-belong-to-an-office-365-group"></a>Löschen von Websites, die ein Office 365-Gruppe gehören:
...
## <a name="delete-communication-sites-or-classic-sites"></a>Kommunikationswebsites oder klassische Websites zu löschen:

1. Wechseln Sie zur Website.
  
2. Klicken Sie auf die ** Einstellungen ** Symbol in der oberen rechten Ecke. 
...
## <a name="delete-a-sharepoint-site-collection"></a>Löschen einer SharePoint-Websitesammlung:
...
## <a name="deleted-a-site-by-accident"></a>Gelöscht eine Site versehentlich?
